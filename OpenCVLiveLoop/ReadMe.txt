========================================================================
    KONSOLENANWENDUNG: OpenCVLiveLoop-Projektübersicht
========================================================================

Diese OpenCVLiveLoop-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre OpenCVLiveLoop-Anwendung besteht.


OpenCVLiveLoop.vcxproj
...
OpenCVLiveLoop.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "OpenCVLiveLoop.pch und eine 
